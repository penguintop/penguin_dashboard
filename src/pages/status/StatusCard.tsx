...
import { NodeAddresses, Topology } from '../../penjs'
        ...
        <Typography component="h5" variant="h5" style={{ display: 'flex', justifyContent: 'space-between' }}>
          {isOk && (
            <div>
              ...
              <span>Your Pen node is running as expected</span>
            </div>
          )}
          {!isOk && (
            <div>
              <Error style={{ color: '#c9201f', marginRight: '7px' }} />
              <span>Could not connect to Pen Node</span>
            </div>
          )}
        </Typography>
        {isOk && (
          <>
            ...
            <div>
              <Typography component="div" variant="subtitle2" gutterBottom>
                <span>AGENT: </span>
                <a href="https://github.com/penguintop/penguin" rel="noreferrer" target="_blank">
                  Pen
                </a>{' '}
