...
export default function Files(): ReactElement {
  ...
  const handleReferenceChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    else setReferenceError(new Error('Incorrect format of penguin hash'))
  }
    ...
    <>
      <Paper className={classes.root}>
        <InputBase
          ...
          placeholder="Enter Penguin reference e.g. 0773a91efd6547c754fc1d95fb1c62c7d1b47f959c2caa685dfec8736da95c1c"
          inputProps={{ 'aria-label': 'retrieve file from penguin' }}
          value={referenceInput}
          onChange={handleReferenceChange}
        />
        <IconButton
          href={`${apiHost}/pen/${referenceInput}`}
          target="_blank"
