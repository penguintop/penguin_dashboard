...
import type { ChequebookAddressResponse } from '../../penjs'
        ...
        {!isLoading && (
          <CardContent className={classes.gridContainer}>
            <div>
              ...
              <Typography variant="h5">{chequebookBalance?.totalBalance.toFixedDecimal()} PEN</Typography>
            </div>
            <div>
              <Typography component="h2" variant="h6" color="primary" gutterBottom>
                Available Uncommitted Balance
              </Typography>
              <Typography variant="h5">{chequebookBalance?.availableBalance.toFixedDecimal()} PEN</Typography>
            </div>
            <div>
              <Typography component="h2" variant="h6" color="primary" gutterBottom>
                Total Sent / Received
              ...
              <Typography variant="h5">
                {totalsent.toFixedDecimal()} / {totalreceived.toFixedDecimal()} PEN
              </Typography>
            </div>
          </CardContent>
        )}
