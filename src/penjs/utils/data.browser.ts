 ...
 */
export function prepareData(data: string | ArrayBuffer | Uint8Array): Uint8Array {
...
export async function prepareWebsocketData(data: string | ArrayBuffer | Blob): Promise<Uint8Array> {
  if (typeof data === 'string') return new TextEncoder().encode(data)
